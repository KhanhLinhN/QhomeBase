    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/confirm-reset").permitAll()
                        .requestMatchers("/api/auth/request-email-verification").permitAll()
                        .requestMatchers("/api/auth/verify-email-otp").permitAll()
                        .requestMatchers("/api/auth/check-email-verified/**").permitAll()
                        .requestMatchers("/api/auth/check-email-exists/**").permitAll()
