...
class HouseholdMemberControllerTest {
    ...
    void shouldGetActiveMembersByHouseholdId() throws Exception {
        ...
        var dto = new HouseholdMemberDto(
                ...
                java.time.OffsetDateTime.now(),
                java.time.OffsetDateTime.now());
        Mockito.when(houseHoldMemberService.getActiveMembersByHouseholdId(any(UUID.class))).thenReturn(List.of(dto));
    ...
    void shouldGetActiveMembersByResidentId() throws Exception {
        ...
        var dto = new HouseholdMemberDto(
                ...
                java.time.OffsetDateTime.now(),
                java.time.OffsetDateTime.now());
        Mockito.when(houseHoldMemberService.getActiveMembersByResidentId(any(UUID.class))).thenReturn(List.of(dto));
