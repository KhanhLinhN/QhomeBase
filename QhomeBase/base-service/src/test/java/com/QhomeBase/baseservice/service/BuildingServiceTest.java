...
//         BuildingCreateReq request = new BuildingCreateReq(buildingName, buildingAddress, numberOfFloors);
...
//         BuildingUpdateReq request = new BuildingUpdateReq(buildingName, buildingAddress, numberOfFloors);
